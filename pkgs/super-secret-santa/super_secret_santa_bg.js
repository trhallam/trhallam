 ...
 * @returns {string}
 */
export function decrypt_secret_santa(key, nonce, ciphertext) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        wasm.decrypt_secret_santa(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
 ...
 * @returns {any}
 */
export function get_secret_santas(instructions) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(instructions, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.get_secret_santas(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
